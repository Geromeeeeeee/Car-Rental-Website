...
if($_SERVER['REQUEST_METHOD'] === 'GET'){
    $fetch_history = "SELECT r.car_id, r.rental_date, r.rental_duration_days, r.total_cost, r.request_status, r.request_id, r.payment_status ,c.image, c.model FROM rental_requests r INNER JOIN cars c ON r.car_id = c.car_id WHERE r.user_id = ? AND request_status IN ('Pending', 'Approved', 'Cancelled', 'Returned','Early Return Requested', 'Picked Up', 'Early Return Approved', 'Return Approved', 'Return Requested')";
